...
class ExtraPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: const DrawerMenu(currentRoute: '/extras'),
      body: Center(
        child: Column(
          ...
          children: [
            ClipRRect(
              ...
              child: Image.network(
                "https://raw.githubusercontent.com/zaav-0442/U2_Act3_Drawer/refs/heads/main/pags/extras.jpg",
                width: 200, height: 200, fit: BoxFit.cover,
              ),
            ),
            const SizedBox(height: 30),
            const Text(
              "Ahora estás en la página de Extras",
              style: TextStyle(color: Color(0xFFD642A7), fontSize: 18, fontWeight: FontWeight.bold),
            ),
            const Padding(
              padding: EdgeInsets.all(15.0),
              child: Text(
                "¿Quieres algo más? Aquí mismo lo encuentras.",
